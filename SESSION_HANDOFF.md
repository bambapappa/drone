...
- **Status och SHA-roller:** `DONE_WITH_CONCERNS` på branch `fix/smoke-scene-compensated-motion`. Kod under test är exakt `c82d07fba818e2e44e883540efcb9516361120b0`. Initial Task 3-resultatdokumentation är exakt `7c18c5a01124808877de1331b82edcecc94bfcb1`. Den efterföljande auditability-commiten tillför endast reproducerbart mätkvitto och spårbarhet; ingen kod eller tröskel ändras. Dess exakta SHA skrivs in av en separat handoff-only-commit, eftersom en commit inte kan självreferera sin egen SHA.
