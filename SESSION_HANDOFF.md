...
- **Status och SHA-roller:** `DONE_WITH_CONCERNS` på branch `fix/smoke-scene-compensated-motion`. Kod under test är exakt `c82d07fba818e2e44e883540efcb9516361120b0`. Initial Task 3-resultatdokumentation är exakt `7c18c5a01124808877de1331b82edcecc94bfcb1`. Auditability-uppföljningen är exakt `ae745e206850922b408c1887756c4f0b79c52ec6`; den tillför endast reproducerbart mätkvitto och spårbarhet, ingen kod eller tröskel. Denna handoff-only-commit anger föregångarens SHA i stället för att låtsas kunna självreferera sin egen.
