"""Analysis package: flow helpers (BoxFilter, GlobalMotion).

Carried forward from tests/test_flow.py — same logic, now importing from analysis.
"""

import cv2
import numpy as np

from analysis.flow import BoxFilter, GlobalMotion
